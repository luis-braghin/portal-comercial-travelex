...
if selected == "🏠 Início":
    ...
    if secao_nome == "📁 KYC e Documentos de Abertura":
        pf_docs = [(nome, link) for nome, link in conteudos[secao_nome] if "PF –" in nome]
        pj_docs = [(nome, link) for nome, link in conteudos[secao_nome] if "PJ –" in nome]
